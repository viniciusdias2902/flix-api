...
from reviews.views import ReviewCreateListView, ReviewRetrieveUpdateDeleteView
...
urlpatterns = [
    ...
    path('reviews/<int:pk>/', ReviewRetrieveUpdateDeleteView.as_view(), name='review-retrieve-update-destroy'),
]
